...
export function CaseStudyTeaser() {
  return (
    <section id="case-study" className="relative py-28">
          ...
          {caseStudies.map((study, index) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="mt-4 font-display text-3xl font-semibold leading-tight tracking-tight text-white sm:text-4xl">
                  {study.title}
                </h3>
